        ...
        <section className="mb-8 grid overflow-hidden rounded-lg bg-[#f2f2f2] md:grid-cols-2">
          ...
          <div className="flex flex-col justify-center p-8">
            ...
            <p className="mt-3 max-w-sm text-sm text-gray-500">
              Do not miss out shopping collection from us. You will not be let
              down.
            </p>
          </div>
        </section>
        ...
        <div className="grid gap-8 md:grid-cols-[190px_1fr] animate-in fade-in duration-500">
          ...
          <section className="animate-in fade-in slide-in-from-right-4 duration-500 delay-75 fill-mode-both">
            <div className="flex items-center justify-between mb-5">
              <div>
                <Breadcrumb className=" font-medium text-gray-600">
                  <BreadcrumbList>
                    {/* Home Link */}
                    <BreadcrumbItem>
                ...
                <Drawer>
                  ...
                  <DrawerContent>
                    <div className="p-6 max-h-[60vh] overflow-y-auto">
                      <h3 className="text-base font-bold text-neutral-900 mb-4 pb-2 border-b border-neutral-100">
                        Filters
                      </h3>
                      <ProductListSidebar />
                    </div>
